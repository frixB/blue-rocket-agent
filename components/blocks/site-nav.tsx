...
export function SiteNav() {
  return (
    <nav aria-label="Main" className="flex items-center justify-between gap-3">
      ...
      <div className="flex items-center gap-4 whitespace-nowrap type-body sm:gap-6">
        <a href="#included" className="hidden text-ink-2 hover:text-ink md:inline">What you get</a>
        <a href="#pricing" className="hidden text-ink-2 hover:text-ink md:inline">Pricing</a>
        <Link href="/reports" className="hidden text-ink-2 hover:text-ink sm:inline">My Reports</Link>
