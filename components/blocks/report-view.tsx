...
import { Card, Chip, Heading, Icon, IconTile, Note, Stat, SummaryRow, buttonStyles } from "@/components/ui";
import { SLA, formatDate, formatDuration, formatPrice, formatPriceShort } from "@/lib/orders/sla";
  ...
  return (
    <>
      ...
      <div className="mx-auto grid w-full max-w-report gap-8 px-5 pb-page-bottom pt-12 lg:grid-cols-[1fr_var(--container-side)]">
        <main id="main" className="flex min-w-0 flex-col gap-section">
          <Card>
            {mode === "owner"
            ...
            <div className="flex flex-wrap items-center justify-between gap-4">
              ...
              {mode === "owner" && (
                <div className="flex flex-wrap items-start gap-2.5">
                  <PdfDownload id={`${order.id}-detail`} variant="primary" />
          ...
          {mode === "shared" && (
            <section data-theme="marketing" aria-labelledby="cta-title" className="flex flex-col items-center gap-3.5 rounded-card bg-page px-card py-9 text-center text-ink">
              ...
              <p className="max-w-xl type-body text-ink-2">Full SEO report, {formatPriceShort(SLA.priceCents)} flat, delivered within one business day. No subscription, no agency retainer.</p>
