  ...
  return (
    ...
    >
      <Card>
        ...
        <pre className="overflow-x-auto rounded-lg bg-inverse p-4 font-mono text-sm text-on-inverse">{"User-agent: BlueRocketBot\nAllow: /"}</pre>
        ...
        <div className="flex flex-col gap-2.5">
          ...
          <Button variant="secondary" full>Audit a different URL instead</Button>
          <Button variant="ghost" full>Refund my payment</Button>
        </div>
      </Card>
    </StatusLayout>
  );
